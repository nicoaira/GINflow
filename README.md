...
5. Build a reusable FAISS database (`--faiss_index FlatIP` by default; IVF/HNSW/PQ/LSH/SQ also supported) and/or search it for seeds. `--faiss_gpu` needs `-profile gpu`.
